...
func FreeTierLimits() Limits {
	return Limits{
		...
		MaxPromptTokens:      4000,  // Basic tokens
		...
		WebhooksAllowed:      false, // No webhooks
		MaxWebhooks:          0,     // N/A
		APIAccessAllowed:     false, // No API access
		APIRateLimit:         0,     // N/A
		RealtimeDataAccess:   false, // Delayed data
		HistoricalDataYears:  0,     // No historical data
		AdvancedCharts:       false, // Basic charts
		CustomIndicators:     false, // Standard indicators only
		PortfolioAnalytics:   false, // Basic analytics
		RiskManagementTools:  false, // Basic risk only
		AlertsCount:          5,     // 5 alerts
		CustomReportsAllowed: false, // No custom reports
		PrioritySupport:      false, // Community support
		DedicatedSupport:     false, // No dedicated support
	}
}
