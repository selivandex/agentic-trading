...
// MarketAnalystOutputSchema defines the output schema for Market Analyst
var MarketAnalystOutputSchema = &genai.Schema{
	Type: "OBJECT",
	Properties: map[string]*genai.Schema{
		"trend": {
			Type: "STRING",
			Enum: []string{"strong_bullish", "bullish", "neutral", "bearish", "strong_bearish"},
		},
		"trend_strength": {
			Type:    "NUMBER",
			Minimum: float64Ptr(0),
	...
	Required: []string{"trend", "confidence"},
}
