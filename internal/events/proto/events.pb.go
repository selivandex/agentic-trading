...
// WebSocketEventWrapper wraps all WebSocket event types for efficient type detection
// This allows consumer to determine event type without trial-and-error unmarshaling
type WebSocketEventWrapper struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Event:
	//
	//	*WebSocketEventWrapper_Kline
	//	*WebSocketEventWrapper_Ticker
	//	*WebSocketEventWrapper_Depth
	//	*WebSocketEventWrapper_Trade
	//	*WebSocketEventWrapper_MarkPrice
	//	*WebSocketEventWrapper_Liquidation
	//	*WebSocketEventWrapper_FundingRate
	Event         isWebSocketEventWrapper_Event `protobuf_oneof:"event"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *WebSocketEventWrapper) Reset() {
	*x = WebSocketEventWrapper{}
	mi := &file_internal_events_proto_events_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WebSocketEventWrapper) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WebSocketEventWrapper) ProtoMessage() {}

func (x *WebSocketEventWrapper) ProtoReflect() protoreflect.Message {
	mi := &file_internal_events_proto_events_proto_msgTypes[42]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WebSocketEventWrapper.ProtoReflect.Descriptor instead.
func (*WebSocketEventWrapper) Descriptor() ([]byte, []int) {
	return file_internal_events_proto_events_proto_rawDescGZIP(), []int{42}
}

func (x *WebSocketEventWrapper) GetEvent() isWebSocketEventWrapper_Event {
	if x != nil {
		return x.Event
	}
	return nil
...
func (x *WebSocketEventWrapper) GetKline() *WebSocketKlineEvent {
	if x != nil {
		if x, ok := x.Event.(*WebSocketEventWrapper_Kline); ok {
			return x.Kline
		}
	}
	return nil
...
func (x *WebSocketEventWrapper) GetTicker() *WebSocketTickerEvent {
	if x != nil {
		if x, ok := x.Event.(*WebSocketEventWrapper_Ticker); ok {
			return x.Ticker
		}
	}
	return nil
...
func (x *WebSocketEventWrapper) GetDepth() *WebSocketDepthEvent {
	if x != nil {
		if x, ok := x.Event.(*WebSocketEventWrapper_Depth); ok {
			return x.Depth
		}
	}
	return nil
...
func (x *WebSocketEventWrapper) GetTrade() *WebSocketTradeEvent {
	if x != nil {
		if x, ok := x.Event.(*WebSocketEventWrapper_Trade); ok {
			return x.Trade
		}
	}
	return nil
...
func (x *WebSocketEventWrapper) GetMarkPrice() *WebSocketMarkPriceEvent {
	if x != nil {
		if x, ok := x.Event.(*WebSocketEventWrapper_MarkPrice); ok {
			return x.MarkPrice
		}
	}
	return nil
...
func (x *WebSocketEventWrapper) GetLiquidation() *WebSocketLiquidationEvent {
	if x != nil {
		if x, ok := x.Event.(*WebSocketEventWrapper_Liquidation); ok {
...
func (x *WebSocketEventWrapper) GetFundingRate() *WebSocketFundingRateEvent {
	if x != nil {
		if x, ok := x.Event.(*WebSocketEventWrapper_FundingRate); ok {
			return x.FundingRate
		}
	}
	return nil
...
type isWebSocketEventWrapper_Event interface {
	isWebSocketEventWrapper_Event()
}

type WebSocketEventWrapper_Kline struct {
	Kline *WebSocketKlineEvent `protobuf:"bytes,1,opt,name=kline,proto3,oneof"`
}

type WebSocketEventWrapper_Ticker struct {
	Ticker *WebSocketTickerEvent `protobuf:"bytes,2,opt,name=ticker,proto3,oneof"`
}

type WebSocketEventWrapper_Depth struct {
	Depth *WebSocketDepthEvent `protobuf:"bytes,3,opt,name=depth,proto3,oneof"`
}

type WebSocketEventWrapper_Trade struct {
	Trade *WebSocketTradeEvent `protobuf:"bytes,4,opt,name=trade,proto3,oneof"`
}

type WebSocketEventWrapper_MarkPrice struct {
	MarkPrice *WebSocketMarkPriceEvent `protobuf:"bytes,5,opt,name=mark_price,json=markPrice,proto3,oneof"`
}

type WebSocketEventWrapper_Liquidation struct {
	Liquidation *WebSocketLiquidationEvent `protobuf:"bytes,6,opt,name=liquidation,proto3,oneof"`
}

type WebSocketEventWrapper_FundingRate struct {
	FundingRate *WebSocketFundingRateEvent `protobuf:"bytes,7,opt,name=funding_rate,json=fundingRate,proto3,oneof"`
}

func (*WebSocketEventWrapper_Kline) isWebSocketEventWrapper_Event() {}

func (*WebSocketEventWrapper_Ticker) isWebSocketEventWrapper_Event() {}

func (*WebSocketEventWrapper_Depth) isWebSocketEventWrapper_Event() {}

func (*WebSocketEventWrapper_Trade) isWebSocketEventWrapper_Event() {}

func (*WebSocketEventWrapper_MarkPrice) isWebSocketEventWrapper_Event() {}

func (*WebSocketEventWrapper_Liquidation) isWebSocketEventWrapper_Event() {}

func (*WebSocketEventWrapper_FundingRate) isWebSocketEventWrapper_Event() {}
...
// UserDataEventWrapper wraps all User Data event types for efficient type detection
// This allows consumer to determine event type without trial-and-error unmarshaling
type UserDataEventWrapper struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Event:
	//
	//	*UserDataEventWrapper_OrderUpdate
	//	*UserDataEventWrapper_PositionUpdate
	//	*UserDataEventWrapper_BalanceUpdate
	//	*UserDataEventWrapper_MarginCall
	//	*UserDataEventWrapper_AccountConfig
	Event         isUserDataEventWrapper_Event `protobuf_oneof:"event"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UserDataEventWrapper) Reset() {
	*x = UserDataEventWrapper{}
	mi := &file_internal_events_proto_events_proto_msgTypes[49]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserDataEventWrapper) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserDataEventWrapper) ProtoMessage() {}

func (x *UserDataEventWrapper) ProtoReflect() protoreflect.Message {
	mi := &file_internal_events_proto_events_proto_msgTypes[49]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserDataEventWrapper.ProtoReflect.Descriptor instead.
func (*UserDataEventWrapper) Descriptor() ([]byte, []int) {
	return file_internal_events_proto_events_proto_rawDescGZIP(), []int{49}
}

func (x *UserDataEventWrapper) GetEvent() isUserDataEventWrapper_Event {
	if x != nil {
		return x.Event
	}
	return nil
...
func (x *UserDataEventWrapper) GetOrderUpdate() *UserDataOrderUpdateEvent {
	if x != nil {
		if x, ok := x.Event.(*UserDataEventWrapper_OrderUpdate); ok {
...
func (x *UserDataEventWrapper) GetPositionUpdate() *UserDataPositionUpdateEvent {
	if x != nil {
		if x, ok := x.Event.(*UserDataEventWrapper_PositionUpdate); ok {
...
func (x *UserDataEventWrapper) GetBalanceUpdate() *UserDataBalanceUpdateEvent {
	if x != nil {
		if x, ok := x.Event.(*UserDataEventWrapper_BalanceUpdate); ok {
...
func (x *UserDataEventWrapper) GetMarginCall() *UserDataMarginCallEvent {
	if x != nil {
		if x, ok := x.Event.(*UserDataEventWrapper_MarginCall); ok {
			return x.MarginCall
		}
	}
	return nil
...
func (x *UserDataEventWrapper) GetAccountConfig() *UserDataAccountConfigEvent {
	if x != nil {
		if x, ok := x.Event.(*UserDataEventWrapper_AccountConfig); ok {
...
type isUserDataEventWrapper_Event interface {
	isUserDataEventWrapper_Event()
}

type UserDataEventWrapper_OrderUpdate struct {
	OrderUpdate *UserDataOrderUpdateEvent `protobuf:"bytes,1,opt,name=order_update,json=orderUpdate,proto3,oneof"`
}

type UserDataEventWrapper_PositionUpdate struct {
	PositionUpdate *UserDataPositionUpdateEvent `protobuf:"bytes,2,opt,name=position_update,json=positionUpdate,proto3,oneof"`
}

type UserDataEventWrapper_BalanceUpdate struct {
	BalanceUpdate *UserDataBalanceUpdateEvent `protobuf:"bytes,3,opt,name=balance_update,json=balanceUpdate,proto3,oneof"`
}

type UserDataEventWrapper_MarginCall struct {
	MarginCall *UserDataMarginCallEvent `protobuf:"bytes,4,opt,name=margin_call,json=marginCall,proto3,oneof"`
}

type UserDataEventWrapper_AccountConfig struct {
	AccountConfig *UserDataAccountConfigEvent `protobuf:"bytes,5,opt,name=account_config,json=accountConfig,proto3,oneof"`
}

func (*UserDataEventWrapper_OrderUpdate) isUserDataEventWrapper_Event() {}

func (*UserDataEventWrapper_PositionUpdate) isUserDataEventWrapper_Event() {}

func (*UserDataEventWrapper_BalanceUpdate) isUserDataEventWrapper_Event() {}

func (*UserDataEventWrapper_MarginCall) isUserDataEventWrapper_Event() {}

func (*UserDataEventWrapper_AccountConfig) isUserDataEventWrapper_Event() {}
...
func (x *ExchangeDeactivatedEvent) Reset() {
	*x = ExchangeDeactivatedEvent{}
	mi := &file_internal_events_proto_events_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExchangeDeactivatedEvent) Descriptor() ([]byte, []int) {
	return file_internal_events_proto_events_proto_rawDescGZIP(), []int{50}
}
...
// PortfolioInitializationJobEvent is published to trigger async portfolio creation workflow
type PortfolioInitializationJobEvent struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Base              *BaseEvent             `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	...
	ExchangeAccountId string                 `protobuf:"bytes,6,opt,name=exchange_account_id,json=exchangeAccountId,proto3" json:"exchange_account_id,omitempty"` // Optional, empty string if not set
	RiskProfile       string                 `protobuf:"bytes,7,opt,name=risk_profile,json=riskProfile,proto3" json:"risk_profile,omitempty"`                     // "conservative", "moderate", "aggressive"
	MarketType        string                 `protobuf:"bytes,8,opt,name=market_type,json=marketType,proto3" json:"market_type,omitempty"`                        // "spot", "futures"
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *PortfolioInitializationJobEvent) Reset() {
	*x = PortfolioInitializationJobEvent{}
	mi := &file_internal_events_proto_events_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PortfolioInitializationJobEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PortfolioInitializationJobEvent) ProtoMessage() {}

func (x *PortfolioInitializationJobEvent) ProtoReflect() protoreflect.Message {
	mi := &file_internal_events_proto_events_proto_msgTypes[51]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PortfolioInitializationJobEvent.ProtoReflect.Descriptor instead.
func (*PortfolioInitializationJobEvent) Descriptor() ([]byte, []int) {
	return file_internal_events_proto_events_proto_rawDescGZIP(), []int{51}
}

func (x *PortfolioInitializationJobEvent) GetBase() *BaseEvent {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *PortfolioInitializationJobEvent) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *PortfolioInitializationJobEvent) GetStrategyId() string {
	if x != nil {
		return x.StrategyId
	}
	return ""
...
func (x *PortfolioInitializationJobEvent) GetTelegramId() int64 {
	if x != nil {
		return x.TelegramId
	}
	return 0
...
func (x *PortfolioInitializationJobEvent) GetCapital() float64 {
	if x != nil {
		return x.Capital
	}
	return 0
...
func (x *PortfolioInitializationJobEvent) GetExchangeAccountId() string {
	if x != nil {
...
func (x *PortfolioInitializationJobEvent) GetRiskProfile() string {
	if x != nil {
...
func (x *PortfolioInitializationJobEvent) GetMarketType() string {
	if x != nil {
		return x.MarketType
	}
	return ""
...
// InvestmentAcceptedEvent notifies user that investment was accepted and processing started
type InvestmentAcceptedEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Base          *BaseEvent             `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	...
	RiskProfile   string                 `protobuf:"bytes,4,opt,name=risk_profile,json=riskProfile,proto3" json:"risk_profile,omitempty"`
	Exchange      string                 `protobuf:"bytes,5,opt,name=exchange,proto3" json:"exchange,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *InvestmentAcceptedEvent) Reset() {
	*x = InvestmentAcceptedEvent{}
	mi := &file_internal_events_proto_events_proto_msgTypes[52]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InvestmentAcceptedEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InvestmentAcceptedEvent) ProtoMessage() {}

func (x *InvestmentAcceptedEvent) ProtoReflect() protoreflect.Message {
	mi := &file_internal_events_proto_events_proto_msgTypes[52]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InvestmentAcceptedEvent.ProtoReflect.Descriptor instead.
func (*InvestmentAcceptedEvent) Descriptor() ([]byte, []int) {
	return file_internal_events_proto_events_proto_rawDescGZIP(), []int{52}
}

func (x *InvestmentAcceptedEvent) GetBase() *BaseEvent {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *InvestmentAcceptedEvent) GetTelegramId() int64 {
	if x != nil {
		return x.TelegramId
	}
	return 0
...
func (x *InvestmentAcceptedEvent) GetCapital() float64 {
	if x != nil {
		return x.Capital
	}
	return 0
...
func (x *InvestmentAcceptedEvent) GetRiskProfile() string {
	if x != nil {
		return x.RiskProfile
	}
	return ""
...
func (x *InvestmentAcceptedEvent) GetExchange() string {
	if x != nil {
		return x.Exchange
	}
	return ""
...
// PortfolioCreatedEvent notifies user that portfolio was successfully created
type PortfolioCreatedEvent struct {
	...
	Invested       float64                `protobuf:"fixed64,5,opt,name=invested,proto3" json:"invested,omitempty"`
	PositionsCount int32                  `protobuf:"varint,6,opt,name=positions_count,json=positionsCount,proto3" json:"positions_count,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *PortfolioCreatedEvent) Reset() {
	*x = PortfolioCreatedEvent{}
	mi := &file_internal_events_proto_events_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PortfolioCreatedEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PortfolioCreatedEvent) ProtoMessage() {}

func (x *PortfolioCreatedEvent) ProtoReflect() protoreflect.Message {
	mi := &file_internal_events_proto_events_proto_msgTypes[53]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PortfolioCreatedEvent.ProtoReflect.Descriptor instead.
func (*PortfolioCreatedEvent) Descriptor() ([]byte, []int) {
	return file_internal_events_proto_events_proto_rawDescGZIP(), []int{53}
}

func (x *PortfolioCreatedEvent) GetBase() *BaseEvent {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *PortfolioCreatedEvent) GetTelegramId() int64 {
	if x != nil {
		return x.TelegramId
	}
	return 0
...
func (x *PortfolioCreatedEvent) GetStrategyId() string {
	if x != nil {
		return x.StrategyId
	}
	return ""
...
func (x *PortfolioCreatedEvent) GetStrategyName() string {
	if x != nil {
		return x.StrategyName
	}
	return ""
...
func (x *PortfolioCreatedEvent) GetInvested() float64 {
	if x != nil {
		return x.Invested
	}
	return 0
...
func (x *PortfolioCreatedEvent) GetPositionsCount() int32 {
	if x != nil {
...
const file_internal_events_proto_events_proto_rawDesc = "" +
	...
	"\n" +
	"event_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\teventTime\"\xc8\x03\n" +
	"\x15WebSocketEventWrapper\x123\n" +
	"\x05kline\x18\x01 \x01(\v2\x1b.events.WebSocketKlineEventH\x00R\x05kline\x126\n" +
	"\x06ticker\x18\x02 \x01(\v2\x1c.events.WebSocketTickerEventH\x00R\x06ticker\x123\n" +
	"\x05depth\x18\x03 \x01(\v2\x1b.events.WebSocketDepthEventH\x00R\x05depth\x123\n" +
	"\x05trade\x18\x04 \x01(\v2\x1b.events.WebSocketTradeEventH\x00R\x05trade\x12@\n" +
	"\n" +
	"mark_price\x18\x05 \x01(\v2\x1f.events.WebSocketMarkPriceEventH\x00R\tmarkPrice\x12E\n" +
	"\vliquidation\x18\x06 \x01(\v2!.events.WebSocketLiquidationEventH\x00R\vliquidation\x12F\n" +
	"\ffunding_rate\x18\a \x01(\v2!.events.WebSocketFundingRateEventH\x00R\vfundingRateB\a\n" +
	"\x05event\"\xf6\x05\n" +
	...
	"\n" +
	"event_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\teventTime\"\x94\x03\n" +
	"\x14UserDataEventWrapper\x12E\n" +
	"\forder_update\x18\x01 \x01(\v2 .events.UserDataOrderUpdateEventH\x00R\vorderUpdate\x12N\n" +
	"\x0fposition_update\x18\x02 \x01(\v2#.events.UserDataPositionUpdateEventH\x00R\x0epositionUpdate\x12K\n" +
	"\x0ebalance_update\x18\x03 \x01(\v2\".events.UserDataBalanceUpdateEventH\x00R\rbalanceUpdate\x12B\n" +
	"\vmargin_call\x18\x04 \x01(\v2\x1f.events.UserDataMarginCallEventH\x00R\n" +
	"marginCall\x12K\n" +
	"\x0eaccount_config\x18\x05 \x01(\v2\".events.UserDataAccountConfigEventH\x00R\raccountConfigB\a\n" +
	"\x05event\"\xee\x01\n" +
	...
	"\n" +
	"is_testnet\x18\a \x01(\bR\tisTestnet\"\xb1\x02\n" +
	"\x1fPortfolioInitializationJobEvent\x12%\n" +
	"\x04base\x18\x01 \x01(\v2\x11.events.BaseEventR\x04base\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x1f\n" +
	"\vstrategy_id\x18\x03 \x01(\tR\n" +
	"strategyId\x12\x1f\n" +
	"\vtelegram_id\x18\x04 \x01(\x03R\n" +
	"telegramId\x12\x18\n" +
	"\acapital\x18\x05 \x01(\x01R\acapital\x12.\n" +
	"\x13exchange_account_id\x18\x06 \x01(\tR\x11exchangeAccountId\x12!\n" +
	"\frisk_profile\x18\a \x01(\tR\vriskProfile\x12\x1f\n" +
	"\vmarket_type\x18\b \x01(\tR\n" +
	"marketType\"\xba\x01\n" +
	"\x17InvestmentAcceptedEvent\x12%\n" +
	"\x04base\x18\x01 \x01(\v2\x11.events.BaseEventR\x04base\x12\x1f\n" +
	"\vtelegram_id\x18\x02 \x01(\x03R\n" +
	"telegramId\x12\x18\n" +
	"\acapital\x18\x03 \x01(\x01R\acapital\x12!\n" +
	"\frisk_profile\x18\x04 \x01(\tR\vriskProfile\x12\x1a\n" +
	"\bexchange\x18\x05 \x01(\tR\bexchange\"\xea\x01\n" +
	"\x15PortfolioCreatedEvent\x12%\n" +
	"\x04base\x18\x01 \x01(\v2\x11.events.BaseEventR\x04base\x12\x1f\n" +
	"\vtelegram_id\x18\x02 \x01(\x03R\n" +
	"telegramId\x12\x1f\n" +
	"\vstrategy_id\x18\x03 \x01(\tR\n" +
	"strategyId\x12#\n" +
	"\rstrategy_name\x18\x04 \x01(\tR\fstrategyName\x12\x1a\n" +
	"\binvested\x18\x05 \x01(\x01R\binvested\x12'\n" +
	"\x0fpositions_count\x18\x06 \x01(\x05R\x0epositionsCount*;\n" +
	"\fEventUrgency\x12\a\n" +
	"\x03LOW\x10\x00\x12\n" +
	"\n" +
...
var file_internal_events_proto_events_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_internal_events_proto_events_proto_goTypes = []any{
	...
	(*WebSocketEventWrapper)(nil),           // 43: events.WebSocketEventWrapper
	(*UserDataOrderUpdateEvent)(nil),        // 44: events.UserDataOrderUpdateEvent
	(*UserDataPositionUpdateEvent)(nil),     // 45: events.UserDataPositionUpdateEvent
	(*UserDataBalanceUpdateEvent)(nil),      // 46: events.UserDataBalanceUpdateEvent
	(*PositionAtRisk)(nil),                  // 47: events.PositionAtRisk
	(*UserDataMarginCallEvent)(nil),         // 48: events.UserDataMarginCallEvent
	(*UserDataAccountConfigEvent)(nil),      // 49: events.UserDataAccountConfigEvent
	(*UserDataEventWrapper)(nil),            // 50: events.UserDataEventWrapper
	(*ExchangeDeactivatedEvent)(nil),        // 51: events.ExchangeDeactivatedEvent
	(*PortfolioInitializationJobEvent)(nil), // 52: events.PortfolioInitializationJobEvent
	(*InvestmentAcceptedEvent)(nil),         // 53: events.InvestmentAcceptedEvent
	(*PortfolioCreatedEvent)(nil),           // 54: events.PortfolioCreatedEvent
	nil,                                     // 55: events.OpportunityFoundEvent.IndicatorsEntry
	nil,                                     // 56: events.DecisionMadeEvent.ContextEntry
	(*timestamppb.Timestamp)(nil),           // 57: google.protobuf.Timestamp
}
var file_internal_events_proto_events_proto_depIdxs = []int32{
	57, // 0: events.BaseEvent.timestamp:type_name -> google.protobuf.Timestamp
	1,  // 1: events.AIUsageEvent.base:type_name -> events.BaseEvent
	1,  // 2: events.OpportunityFoundEvent.base:type_name -> events.BaseEvent
	55, // 3: events.OpportunityFoundEvent.indicators:type_name -> events.OpportunityFoundEvent.IndicatorsEntry
	...
	57, // 10: events.CircuitBreakerTrippedEvent.resume_at:type_name -> google.protobuf.Timestamp
	...
	56, // 13: events.DecisionMadeEvent.context:type_name -> events.DecisionMadeEvent.ContextEntry
	1,  // 14: events.WorkerFailedEvent.base:type_name -> events.BaseEvent
	57, // 15: events.WorkerFailedEvent.last_success:type_name -> google.protobuf.Timestamp
	...
	57, // 46: events.WebSocketKlineEvent.open_time:type_name -> google.protobuf.Timestamp
	57, // 47: events.WebSocketKlineEvent.close_time:type_name -> google.protobuf.Timestamp
	57, // 48: events.WebSocketKlineEvent.event_time:type_name -> google.protobuf.Timestamp
	1,  // 49: events.WebSocketTickerEvent.base:type_name -> events.BaseEvent
	57, // 50: events.WebSocketTickerEvent.open_time:type_name -> google.protobuf.Timestamp
	57, // 51: events.WebSocketTickerEvent.close_time:type_name -> google.protobuf.Timestamp
	57, // 52: events.WebSocketTickerEvent.event_time:type_name -> google.protobuf.Timestamp
	...
	57, // 56: events.WebSocketDepthEvent.event_time:type_name -> google.protobuf.Timestamp
	1,  // 57: events.WebSocketTradeEvent.base:type_name -> events.BaseEvent
	57, // 58: events.WebSocketTradeEvent.trade_time:type_name -> google.protobuf.Timestamp
	57, // 59: events.WebSocketTradeEvent.event_time:type_name -> google.protobuf.Timestamp
	1,  // 60: events.WebSocketFundingRateEvent.base:type_name -> events.BaseEvent
	57, // 61: events.WebSocketFundingRateEvent.funding_time:type_name -> google.protobuf.Timestamp
	57, // 62: events.WebSocketFundingRateEvent.next_funding_time:type_name -> google.protobuf.Timestamp
	57, // 63: events.WebSocketFundingRateEvent.event_time:type_name -> google.protobuf.Timestamp
	1,  // 64: events.WebSocketMarkPriceEvent.base:type_name -> events.BaseEvent
	57, // 65: events.WebSocketMarkPriceEvent.next_funding_time:type_name -> google.protobuf.Timestamp
	57, // 66: events.WebSocketMarkPriceEvent.event_time:type_name -> google.protobuf.Timestamp
	1,  // 67: events.WebSocketLiquidationEvent.base:type_name -> events.BaseEvent
	57, // 68: events.WebSocketLiquidationEvent.event_time:type_name -> google.protobuf.Timestamp
	35, // 69: events.WebSocketEventWrapper.kline:type_name -> events.WebSocketKlineEvent
	36, // 70: events.WebSocketEventWrapper.ticker:type_name -> events.WebSocketTickerEvent
	38, // 71: events.WebSocketEventWrapper.depth:type_name -> events.WebSocketDepthEvent
	39, // 72: events.WebSocketEventWrapper.trade:type_name -> events.WebSocketTradeEvent
	41, // 73: events.WebSocketEventWrapper.mark_price:type_name -> events.WebSocketMarkPriceEvent
	42, // 74: events.WebSocketEventWrapper.liquidation:type_name -> events.WebSocketLiquidationEvent
	40, // 75: events.WebSocketEventWrapper.funding_rate:type_name -> events.WebSocketFundingRateEvent
	1,  // 76: events.UserDataOrderUpdateEvent.base:type_name -> events.BaseEvent
	57, // 77: events.UserDataOrderUpdateEvent.trade_time:type_name -> google.protobuf.Timestamp
	57, // 78: events.UserDataOrderUpdateEvent.event_time:type_name -> google.protobuf.Timestamp
	1,  // 79: events.UserDataPositionUpdateEvent.base:type_name -> events.BaseEvent
	57, // 80: events.UserDataPositionUpdateEvent.event_time:type_name -> google.protobuf.Timestamp
	1,  // 81: events.UserDataBalanceUpdateEvent.base:type_name -> events.BaseEvent
	57, // 82: events.UserDataBalanceUpdateEvent.event_time:type_name -> google.protobuf.Timestamp
	1,  // 83: events.UserDataMarginCallEvent.base:type_name -> events.BaseEvent
	47, // 84: events.UserDataMarginCallEvent.positions_at_risk:type_name -> events.PositionAtRisk
	57, // 85: events.UserDataMarginCallEvent.event_time:type_name -> google.protobuf.Timestamp
	1,  // 86: events.UserDataAccountConfigEvent.base:type_name -> events.BaseEvent
	57, // 87: events.UserDataAccountConfigEvent.event_time:type_name -> google.protobuf.Timestamp
	44, // 88: events.UserDataEventWrapper.order_update:type_name -> events.UserDataOrderUpdateEvent
	45, // 89: events.UserDataEventWrapper.position_update:type_name -> events.UserDataPositionUpdateEvent
	46, // 90: events.UserDataEventWrapper.balance_update:type_name -> events.UserDataBalanceUpdateEvent
	48, // 91: events.UserDataEventWrapper.margin_call:type_name -> events.UserDataMarginCallEvent
	49, // 92: events.UserDataEventWrapper.account_config:type_name -> events.UserDataAccountConfigEvent
	1,  // 93: events.ExchangeDeactivatedEvent.base:type_name -> events.BaseEvent
	1,  // 94: events.PortfolioInitializationJobEvent.base:type_name -> events.BaseEvent
	1,  // 95: events.InvestmentAcceptedEvent.base:type_name -> events.BaseEvent
	1,  // 96: events.PortfolioCreatedEvent.base:type_name -> events.BaseEvent
...
func file_internal_events_proto_events_proto_init() {
	...
	file_internal_events_proto_events_proto_msgTypes[42].OneofWrappers = []any{
		(*WebSocketEventWrapper_Kline)(nil),
		(*WebSocketEventWrapper_Ticker)(nil),
		(*WebSocketEventWrapper_Depth)(nil),
		(*WebSocketEventWrapper_Trade)(nil),
		(*WebSocketEventWrapper_MarkPrice)(nil),
		(*WebSocketEventWrapper_Liquidation)(nil),
		(*WebSocketEventWrapper_FundingRate)(nil),
	}
	file_internal_events_proto_events_proto_msgTypes[49].OneofWrappers = []any{
		(*UserDataEventWrapper_OrderUpdate)(nil),
		(*UserDataEventWrapper_PositionUpdate)(nil),
		(*UserDataEventWrapper_BalanceUpdate)(nil),
		(*UserDataEventWrapper_MarginCall)(nil),
		(*UserDataEventWrapper_AccountConfig)(nil),
	}
	type x struct{}
