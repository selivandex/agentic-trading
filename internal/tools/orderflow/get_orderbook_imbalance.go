...
func NewGetOrderbookImbalanceTool(deps shared.Deps) tool.Tool {
	return functiontool.New("get_orderbook_imbalance", "Get OrderBook Imbalance (Bid/Ask Delta)", func(ctx context.Context, args map[string]interface{}) (map[string]interface{}, error) {
