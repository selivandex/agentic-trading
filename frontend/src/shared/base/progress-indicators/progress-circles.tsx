...
export const ProgressBarCircle = ({ value, min = 0, max = 100, size, label, valueFormatter }: ProgressBarCircleProps) => {
...
export const ProgressBarHalfCircle = ({ value, min = 0, max = 100, size, label, valueFormatter }: ProgressBarCircleProps) => {
    const percentage = Math.round(((value - min) * 100) / (max - min));
