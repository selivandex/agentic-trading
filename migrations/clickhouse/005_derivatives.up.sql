...
CREATE TABLE
    IF NOT EXISTS options_snapshots (
...
-- Indexes
-- ============================================================================
CREATE INDEX IF NOT EXISTS idx_options_gamma ON options_snapshots (gamma_exposure) TYPE minmax GRANULARITY 4;

CREATE INDEX IF NOT EXISTS idx_options_flow_premium ON options_flows (premium) TYPE minmax GRANULARITY 4;
